...
Problem #121: Best Time to Buy and Sell Stock. Solve this using efficient algorithms.
...
### Intuition
To solve Best Time to Buy and Sell Stock, we need to leverage the Array / DP pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Array / DP technique to process the data.
