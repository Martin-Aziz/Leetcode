...
Problem #96: Unique Binary Search Trees. Solve this using efficient algorithms.
...
### Intuition
To solve Unique Binary Search Trees, we need to leverage the DP / Math pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the DP / Math technique to process the data.
