...
Problem #114: Flatten Binary Tree to Linked List. Solve this using efficient algorithms.
...
### Intuition
To solve Flatten Binary Tree to Linked List, we need to leverage the Tree / DFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
