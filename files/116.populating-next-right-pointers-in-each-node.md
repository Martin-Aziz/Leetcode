...
Problem #116: Populating Next Right Pointers in Each Node. Solve this using efficient algorithms.
...
### Intuition
To solve Populating Next Right Pointers in Each Node, we need to leverage the Tree / BFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Tree / BFS technique to process the data.
