...
Problem #148: Sort List. Solve this using efficient algorithms.
...
### Intuition
To solve Sort List, we need to leverage the Sorting / Merge Sort pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Sorting / Merge Sort technique to process the data.
