...
Problem #139: Word Break. Solve this using efficient algorithms.
...
### Intuition
To solve Word Break, we need to leverage the DP pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
