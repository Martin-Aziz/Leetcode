...
Problem #50: Pow(x, n). Solve this using efficient algorithms.
...
### Intuition
To solve Pow(x, n), we need to leverage the Recursion / Bit Manipulation pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Recursion / Bit Manipulation technique to process the data.
