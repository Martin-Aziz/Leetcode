...
Problem #100: Same Tree. Solve this using efficient algorithms.
...
### Intuition
To solve Same Tree, we need to leverage the Tree / DFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
