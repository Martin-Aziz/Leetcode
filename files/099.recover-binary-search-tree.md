...
Problem #99: Recover Binary Search Tree. Solve this using efficient algorithms.
...
### Intuition
To solve Recover Binary Search Tree, we need to leverage the Tree / Inorder Traversal pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Tree / Inorder Traversal technique to process the data.
