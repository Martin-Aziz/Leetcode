...
Problem #84: Largest Rectangle in Histogram. Solve this using efficient algorithms.
...
### Intuition
To solve Largest Rectangle in Histogram, we need to leverage the Stack pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
