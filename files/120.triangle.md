...
Problem #120: Triangle. Solve this using efficient algorithms.
...
### Intuition
To solve Triangle, we need to leverage the DP pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
