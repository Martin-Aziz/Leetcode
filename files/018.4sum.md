...
Problem #18: 4Sum. Solve this using efficient algorithms.
...
### Intuition
To solve 4Sum, we need to leverage the Two Pointers pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
