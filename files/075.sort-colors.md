...
Problem #75: Sort Colors. Solve this using efficient algorithms.
...
### Intuition
To solve Sort Colors, we need to leverage the Sorting / Two Pointers pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Sorting / Two Pointers technique to process the data.
