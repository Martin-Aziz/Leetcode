...
Problem #98: Validate Binary Search Tree. Solve this using efficient algorithms.
...
### Intuition
To solve Validate Binary Search Tree, we need to leverage the Tree / DFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
