...
Problem #118: Pascal's Triangle. Solve this using efficient algorithms.
...
### Intuition
To solve Pascal's Triangle, we need to leverage the DP pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
