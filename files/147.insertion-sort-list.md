...
**Difficulty:** Medium  
**Pattern:** Sorting / Linked List

## Problem Statement

Problem #147: Insertion Sort List. Solve this using efficient algorithms.
...
### Intuition
To solve Insertion Sort List, we need to leverage the Sorting / Linked List pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Sorting / Linked List technique to process the data.
