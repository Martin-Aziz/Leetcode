...
Problem #101: Symmetric Tree. Solve this using efficient algorithms.
...
### Intuition
To solve Symmetric Tree, we need to leverage the Tree / BFS / DFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Tree / BFS / DFS technique to process the data.
