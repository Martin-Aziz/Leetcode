...
Problem #95: Unique Binary Search Trees II. Solve this using efficient algorithms.
...
### Intuition
To solve Unique Binary Search Trees II, we need to leverage the DP / Recursion pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the DP / Recursion technique to process the data.
...
class Solution:
    def solve(self, ...):
        # Implementation for Unique Binary Search Trees II
        pass
```
