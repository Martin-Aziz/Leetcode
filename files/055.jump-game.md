...
Problem #55: Jump Game. Solve this using efficient algorithms.
...
### Intuition
To solve Jump Game, we need to leverage the Greedy / DP pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
