...
Problem #145: Binary Tree Postorder Traversal. Solve this using efficient algorithms.
...
### Intuition
To solve Binary Tree Postorder Traversal, we need to leverage the Tree / Stack pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Tree / Stack technique to process the data.
