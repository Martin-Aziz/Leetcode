...
Problem #111: Minimum Depth of Binary Tree. Solve this using efficient algorithms.
...
### Intuition
To solve Minimum Depth of Binary Tree, we need to leverage the Tree / BFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
