...
Problem #89: Gray Code. Solve this using efficient algorithms.
...
### Intuition
To solve Gray Code, we need to leverage the Bit Manipulation / Math pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Bit Manipulation / Math technique to process the data.
