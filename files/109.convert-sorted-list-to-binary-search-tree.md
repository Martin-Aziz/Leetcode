...
**Difficulty:** Medium  
**Pattern:** Tree / Linked List

## Problem Statement

Problem #109: Convert Sorted List to Binary Search Tree. Solve this using efficient algorithms.
...
### Intuition
To solve Convert Sorted List to Binary Search Tree, we need to leverage the Tree / Linked List pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Tree / Linked List technique to process the data.
