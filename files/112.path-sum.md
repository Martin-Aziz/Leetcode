...
Problem #112: Path Sum. Solve this using efficient algorithms.
...
### Intuition
To solve Path Sum, we need to leverage the Tree / DFS pattern. This involves identifying the core constraint and optimizing the traversal or calculation.
