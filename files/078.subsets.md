...
Problem #78: Subsets. Solve this using efficient algorithms.
...
### Intuition
To solve Subsets, we need to leverage the Backtracking / Bit Manipulation pattern. This involves identifying the core constraint and optimizing the traversal or calculation.

### Algorithm Walkthrough
1. Analyze the input constraints and edge cases.
2. Apply the Backtracking / Bit Manipulation technique to process the data.
